...
namespace TheAionProject
{
    ...
    public static class Text
    {
        ...
        public static string CurrentInventory(IEnumerable<TravelerObject> inventory)
        {
            ...
            // display all traveler objects in rows
            //
            string inventoryObjectsRows = null;
            foreach (TravelerObject inventoryObject in inventory)
            {
                inventoryObjectsRows +=
            ...
            messageBoxText += inventoryObjectsRows;

            return messageBoxText;
        }

        public static string GameObjcectsChooseList(IEnumerable<GameObject> gameObjects)
        {
            //
            // display table name and column headers
            //
